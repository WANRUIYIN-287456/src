  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: WebView(
            initialUrl:
                '${Config.server}/LabAssign2/php/payment.php?userid=${widget.user.id}&email=${widget.user.email}&phone=${widget.user.phone}&name=${widget.user.name}&amount=${widget.totalprice}',
