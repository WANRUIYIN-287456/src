...
if(isset($_POST['userid'])){
    ...
    if(isset($_POST['type'])){
        ...
        if ($option != 'All Options') {
            $sqlloadproduct .= " AND product_option = '$option'";
        }
    ...
    if(!isset($_POST['search']) && !isset($_POST['type']) && !isset($_POST['state']) && !isset($_POST['option']) && !isset($_POST['valuea']) && !isset($_POST['valueb'])){
