...
if (isset($_POST['userid']) && isset($_POST['orderbill'])){
	$userid = $_POST['userid'];	
	$orderbill = $_POST['orderbill'];
	$sqlorderdetails = "SELECT * FROM `tbl_orderdetails` INNER JOIN `tbl_products` ON tbl_orderdetails.catch_id = tbl_products.product_id WHERE tbl_orderdetails.user_id = '$userid' AND tbl_orderdetails.order_bill = '$orderbill'";
}
