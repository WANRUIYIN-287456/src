...
import 'package:my_nelayan/screens/login_screen.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void registerUser() {
    ...
    //10.19.84.179
    //10.143.133.90
    http.post(Uri.parse("${Config.server}/MyNelayan/php/register_user.php"),
        //Uri.parse("http://10.19.74.52/MyNelayan/php/register_user.php"),
        body: {
          "name": name,
          "email": email,
          "phone": phone,
