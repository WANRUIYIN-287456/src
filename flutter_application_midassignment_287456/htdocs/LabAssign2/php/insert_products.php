...
$sqlinsert = "INSERT INTO `tbl_products`(`user_id`,`product_name`, `product_desc`, `product_type`, `product_price`, `product_qty`, `product_lat`, `product_long`, `product_state`, `product_locality`, `Product_Image1`,`Product_Image2`, `Product_Image3`) VALUES ('$userid','$product_name','$product_desc','$product_type','$product_price','$product_qty','$latitude','$longitude','$state','$locality', '$image1', '$image2', '$image3')";
