...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2023 at 06:34 AM
...
CREATE TABLE `tbl_cart` (
  ...
  `cart_qty` varchar(6) NOT NULL,
  `cart_price` varchar(12) NOT NULL,
...
INSERT INTO `tbl_cart` (`cart_id`, `cart_qty`, `cart_price`, `user_id`, `barteruser_id`, `cart_date`, `product_id`) VALUES
(10, '1', '21000.0', 3, 3, '2023-06-24 22:05:37.602039', 10);
...
--
ALTER TABLE `tbl_cart`
  MODIFY `cart_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
