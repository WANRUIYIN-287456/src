...
import 'package:checkin_project/main_screen.dart';
...
class SplashScreenState extends State<SplashScreen> {
  ...
  checkAndLogin() async {
    ...
    if (ischeck) {
      try {
        http.post(
            Uri.parse("${Config.server}/OSProject/php/login_user.php"),
      ...
      Timer(
          ...
          () => Navigator.pushReplacement(context,
              MaterialPageRoute(builder: (content) => RegistrationScreen(user: user))));
    }
  }
}