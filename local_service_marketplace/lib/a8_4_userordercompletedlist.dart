...
import 'package:local_service_marketplace/a8_5_userordercompletedetails.dart';
import 'package:local_service_marketplace/config.dart';
import 'package:local_service_marketplace/model/order.dart';
import 'package:local_service_marketplace/model/user.dart';

class UserOrderCompleteList extends StatefulWidget {
  final User user;
  const UserOrderCompleteList({super.key, required this.user});

  @override
  State<UserOrderCompleteList> createState() => _UserOrderCompleteListState();
}

class _UserOrderCompleteListState extends State<UserOrderCompleteList> {
                        ...
                        return ListTile(
                          onTap: () async {
                            ...
                            await Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    UserOrderCompleteDetails(order: order),
                              ),
                            );
                            loaduserorders();
                          },
