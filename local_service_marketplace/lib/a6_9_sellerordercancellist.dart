...
import 'package:local_service_marketplace/a6_10_sellerordercanceldetails.dart';
import 'package:local_service_marketplace/config.dart';
import 'package:local_service_marketplace/model/order.dart';
import 'package:local_service_marketplace/model/user.dart';

class SellerOrderCancelList extends StatefulWidget {
  final User user;
  const SellerOrderCancelList({super.key, required this.user});

  @override
  State<SellerOrderCancelList> createState() => _SellerOrderCancelListState();
}

class _SellerOrderCancelListState extends State<SellerOrderCancelList> {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Padding(
                      ...
                      child: Text("Your Cancelled Order",
                          style: TextStyle(
                            fontSize: 16,
                        ...
                        return ListTile(
                          onTap: () async {
                            ...
                            await Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    SellerOrderCancelDetails(order: order),
                              ),
                            );
                            loaduserorders();
                          },
