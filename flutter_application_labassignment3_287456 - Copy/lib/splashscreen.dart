...
import 'package:flutter_application_labassignment3_287456/screen/main_screen.dart';
import 'package:flutter_application_labassignment3_287456/screen/profile_screen.dart';
import 'package:flutter_application_labassignment3_287456/screen/registration_screen.dart';
          ...
          if (response.statusCode == 200) {
            ...
            Timer(
                ...
                () => Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (content) => ProfileTabScreen(user: user))));
          }
